        ...
        <AppWrapper>
          <Suspense fallback={<CompleteLoadingSpinner />}>
            <Switch>
              ...
              <Route path="/education-detail/name/:name" component={ToEntity}></Route>
              <Route path="/education-detail/id/:id" component={ToEntity}></Route>
              <Route path="/education-overview" component={EntityOverview}></Route>
